...
weight: 20
description: "Development setup, architecture, and workflow"
---
...
For detailed architecture documentation, see [docs/contributor/README.md](/docs/contributor/README/).
...
- [Architecture Overview](/docs/contributor/README/) - System design and components
- [CLI Architecture](/docs/contributor/cli/) - CLI command structure
- [Data Architecture](/docs/contributor/data/) - Recipe data model
- [Bundler Development](/docs/contributor/component/) - Creating new bundlers
