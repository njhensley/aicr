...
weight: 30
description: "Deploy and operate AICR API server on Kubernetes"
---
...
- Custom recipes: Modify embedded recipe data (see [recipes/](https://github.com/NVIDIA/aicr/tree/main/recipes/))
...
- See [Agent Deployment](/docs/user/agent-deployment/)
...
> **Note:** This example shows the concept of mounting custom recipe data. The actual recipe format uses a base-plus-overlay architecture. See [recipes/](https://github.com/NVIDIA/aicr/tree/main/recipes/) for the current schema (`overlays/*.yaml` including `base.yaml`).
...
- [API Reference](/docs/user/api-reference/) - API endpoint documentation
- [Automation](/docs/integrator/automation/) - CI/CD integration
- [Data Flow](/docs/integrator/data-flow/) - Understanding data architecture
- [API Server Architecture](/docs/contributor/api-server/) - Internal architecture
