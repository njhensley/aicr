...
linkTitle: "Recipe Development"
weight: 40
description: "Create and modify recipe metadata"
---
...
Recipe files in [recipes/](https://github.com/NVIDIA/aicr/tree/main/recipes/) are embedded at compile time. Integrators can extend or override using the `--data` flag (see [Advanced Topics](#advanced-topics)).

For query matching and overlay merging internals, see [Data Architecture](/docs/contributor/data/).
...
Tests in [`pkg/recipe/yaml_test.go`](https://github.com/NVIDIA/aicr/tree/main/pkg/recipe/yaml_test.go) validate:
...
1. Create recipe file in [recipes/](https://github.com/NVIDIA/aicr/tree/main/recipes/)
...
- [Data Architecture](/docs/contributor/data/) - Recipe generation process, overlay system, query matching algorithm
- [Bundler Development Guide](/docs/contributor/component/) - Creating new bundlers
- [CLI Reference](/docs/user/cli-reference/) - CLI commands for recipe and bundle generation
- [API Reference](/docs/user/api-reference/) - Programmatic recipe access
