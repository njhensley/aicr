...
linkTitle: "Data Flow"
weight: 20
description: "Data flow architecture through the AICR pipeline"
---
...
- [Data Architecture](/docs/contributor/data/) - Recipe data architecture
- [API Reference](/docs/user/api-reference/) - API endpoint details
- [Automation](/docs/integrator/automation/) - CI/CD integration patterns
- [Contributing](/docs/project/contributing/) - Developer guide
