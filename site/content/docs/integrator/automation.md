...
weight: 10
description: "CI/CD integration patterns for AICR"
---
...
- [Kubernetes Deployment](/docs/integrator/kubernetes-deployment/) - Self-hosted API server
- [CLI Reference](/docs/user/cli-reference/) - CLI commands
- [Agent Deployment](/docs/user/agent-deployment/) - Kubernetes agent
