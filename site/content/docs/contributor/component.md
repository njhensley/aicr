...
weight: 40
description: "Bundler development and component registry"
---
...
See [CLI Architecture](/docs/contributor/cli/#deployer-framework-gitops-integration) for detailed deployer documentation.

## See Also

- [Architecture Overview](/docs/contributor/) - Complete bundler framework architecture
- [CLI Architecture](/docs/contributor/cli/) - Deployer framework and GitOps integration
- [CLI Reference](/docs/user/cli-reference/) - Bundle generation commands
- [API Reference](/docs/user/api-reference/) - Programmatic access (recipe generation only)
- [Component Registry](https://github.com/NVIDIA/aicr/tree/main/recipes/registry.yaml) - Declarative component configuration
- [Recipe Data README](https://github.com/NVIDIA/aicr/tree/main/recipes/README.md) - Recipe and component data overview
