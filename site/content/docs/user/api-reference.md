...
[api/aicr/v1/server.yaml](https://github.com/NVIDIA/aicr/tree/main/api/aicr/v1/server.yaml)
...
- [CLI Reference](/docs/user/cli-reference/) - Command-line interface
- [Agent Deployment](/docs/user/agent-deployment/) - Kubernetes agent for snapshot capture
- [Installation Guide](/docs/user/installation/) - Setup instructions
- [Data Flow](/docs/integrator/data-flow/) - Understanding recipe data architecture
- [Automation Guide](/docs/integrator/automation/) - CI/CD integration patterns
