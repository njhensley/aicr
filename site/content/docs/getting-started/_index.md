...
weight: 10
description: "Overview and quick start guide for AICR"
---
...
|----------|-------------|
| [Installation](/docs/user/installation/) | Installing the `aicr` CLI |
| [CLI Reference](/docs/user/cli-reference/) | Complete CLI command reference with examples |
| [API Reference](/docs/user/api-reference/) | Quick start for the REST API |
| [Agent Deployment](/docs/user/agent-deployment/) | Running the snapshot agent as a Kubernetes Job |
...
| Document | Description |
|----------|-------------|
| [Architecture Overview](/docs/contributor/) | System design, patterns, and deployment topologies |
| [CLI Architecture](/docs/contributor/cli/) | Detailed CLI implementation and workflow diagrams |
| [API Server Architecture](/docs/contributor/api-server/) | HTTP server design, middleware, and endpoints |
| [Data Architecture](/docs/contributor/data/) | Recipe metadata system, criteria matching, and inheritance |
| [Bundler Development](/docs/contributor/component/) | Guide for creating new bundlers |
...
| Document | Description |
|----------|-------------|
| [API Reference](/docs/user/api-reference/) | Complete REST API specification with examples |
| [Automation](/docs/integrator/automation/) | CI/CD integration patterns |
| [Data Flow](/docs/integrator/data-flow/) | Understanding recipe data architecture |
| [Kubernetes Deployment](/docs/integrator/kubernetes-deployment/) | Self-hosted API server deployment |
| [Recipe Development](/docs/integrator/recipe-development/) | Adding and modifying recipe metadata |
...
- **Contributing:** [CONTRIBUTING.md](/docs/project/contributing/)
